...
class Newprofile extends StatefulWidget {
  ...
  const Newprofile({super.key, required this.newuser});
...
class _NewprofileState extends State<Newprofile> {
  late InstaModel Newname;
  late HighlightModel newhighlight;
  late PostModel newpost;
  late TagModel newtag;
  ...
  void initState() {
    BlocProvider.of<InstaBloc>(context)
        .add(Fetchinsta(userName: widget.newuser));
    BlocProvider.of<HighlightBloc>(context)
        .add(FetchHighlight(hightlight: widget.newuser));
    BlocProvider.of<PostBloc>(context)
        .add(FeatchPost(post: widget.newuser));
    BlocProvider.of<TagBloc>(context)
        .add(FeatchTag(tag:widget.newuser));
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
            ...
            return Column(
              ...
              children: [
                  ...
                  child: Row(
                    children: [
                      Padding(
                        ...
                        child: CircleAvatar(
                            ...
                            backgroundImage: NetworkImage(
                                Newname.data!.profilePicUrlHd.toString())),
                      ),
                      SizedBox(
                        width: 15.h,
                      ),
                      Column(
                        children: [
                          Text(
                            Newname.data!.mediaCount.toString(),
                      ...
                      TextButton(
                        onPressed: () { Navigator.of(context).push(MaterialPageRoute(builder: (_)=>Follower(userName:widget.newuser , index: 0))); },
                        child: Column(
                          children: [
                            Text(
                              Newname.data!.followerCount.toString(),
                              textAlign: TextAlign.center,
                              style: GoogleFonts.inter(
                                textStyle: TextStyle(
                                  color: Colors.white,
                      ...
                      TextButton(
                        onPressed: () { Navigator.of(context).push(MaterialPageRoute(builder: (_)=>Follower(userName: widget.newuser, index: 1))); },
                        child: Column(
                          children: [
                            Text(
                              Newname.data!.followingCount.toString(),
                              textAlign: TextAlign.center,
                              style: GoogleFonts.inter(
                                textStyle: TextStyle(
                                  color: Colors.white,
                ...
                Padding(
                  ...
                  child: SizedBox(width: 100.w,height: 28.h,
                    child: Text(
                      Newname.data!.fullName.toString(),
                      textAlign: TextAlign.center,
                      style: GoogleFonts.inter(
                        textStyle: TextStyle(
                          color: Colors.white,
                        ...
                        builder: (context, state) {
                          ...
                          if (state is highlightBlocloaded) {
                            ...
                            return ListView.separated(
                              itemCount: newhighlight.data!.items!.length,
                              ...
                              itemBuilder: (context, position) {
                                return CircleAvatar(
                                  ...
                                  child: Padding(
                                    ...
                                    child: CircleAvatar(
                                      radius: 50.r,
                                      backgroundImage: NetworkImage(newhighlight
                                          .data!
                                          .items![position]
                                          .coverMedia!
                                          .croppedImageVersion!
    ...
    newpost = BlocProvider.of<PostBloc>(context).postModel;
                            return GridView.count(
                              crossAxisCount: 3,
                              shrinkWrap: true,
                              children: List.generate(
                                newpost.data!.items!.length,
                                    (index) {
                                  return Padding(
                                      ...
                                      child: Container(
                                        decoration: BoxDecoration(
                                          ...
                                          image: DecorationImage(
                                            image: NetworkImage(newpost.data!.items![index].imageVersions!.items![0].url.toString()),
                                          ),
                                        ),
                                      ));
                                },
  ...
  builder: (context, state) {
    ...
    newtag=BlocProvider.of<TagBloc>(context).tagModel;

    return GridView.count(
                          crossAxisCount: 3,
                          shrinkWrap: true,
                          children: List.generate(
                            newtag.data!.items!.length,
                                (index) {
                              return Padding(
                                  padding: const EdgeInsets.all(.5),
                                  child: Container(
                                    decoration: BoxDecoration(
                                      color: Colors.white,
                                      image: DecorationImage(
                                        image: NetworkImage(newtag.data!.items![index].displayUrl.toString()),
                                      ),
                                    ),
                                  ));
                            },
